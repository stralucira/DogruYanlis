...
public class SliderCellInt: Cell<Int>, CellType {
    ...
    lazy public var slider: UISlider = {
        ...
        result.minimumTrackTintColor = UIColor( red: 18/255, green: 136/255, blue: 2/255, alpha: 1.0 )
        return result
    }()
    ...
    public override func setup() {
        ...
        slider.addTarget(self, action: #selector(SliderCellInt.valueChanged), for: .valueChanged)
    ...
    public override func update() {
        ...
        slider.value = Float(Int(row.value!))
    }
